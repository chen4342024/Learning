<template>
    <div>
        ...
        <footer class="footer" v-show="todos.length">
            <ul class="filters">
                <li>
                    <a @click="toggleFilter('all')" :class="{ selected: filter == 'all' }">All</a>
                </li>
                <li>
                    <a @click="toggleFilter('active')" :class="{ selected: filter == 'active' }">Active</a>
                </li>
                <li>
                    <a @click="toggleFilter('completed')" :class="{ selected: filter == 'completed' }">Completed</a>
                </li>
            </ul>
        </footer>
    </div>
